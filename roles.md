...
::::::{tab-set}
:::::{tab-item} Role holders
::::{grid} 1 2 3 4
:gutter: 3

:::{grid-item-card} Applications open!
Get in touch!
:::
...
In the past, this role has been held informally by Ben Marzeion (2015-present), Fabien
Maussion (2015-present), Anouk Vlug (2020-present).
...
:::{grid-item-card} Fabien Maussion
2016-present
:::

:::{grid-item-card} Patrick Schmitt
2021-present
:::
...
:::::{tab-item} Past role holders
::::{grid} 1 2 3 4
:gutter: 3

:::{grid-item-card} Matthias Dusch
2018-2021
:::
...
Core developers are responsible for managing code contributions, ensuring software quality,
...
:::{grid-item-card} Timo Rothenpieler
2016-present
:::
...
access to reliable and efficient data and computing resources by managing and maintaining
the underlying hardware and software infrastructure. This role supports the operation of
critical systems and facilitates seamless access to resources for the community's activities.
...
:::{grid-item-card} Anouk Vlug
2020-present
:::

:::{grid-item-card} Lilian Schuster
2020-present
:::

:::{grid-item-card} Beatriz Recinos
2016-present
:::
...
:::{grid-item-card} Lizz Ultee
(2019-present)
:::

:::{grid-item-card} Erik Holmgren
2020-2021
:::
...
:::{grid-item-card} Zora Schirmeister
2019-2020
:::
